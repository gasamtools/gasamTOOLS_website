...
def card_sma50_day_futures_0003_shortSL2SP10(db, signal_db, trade_db, futures_db, signal_trade_db, pair, command):
...
# FETCH ALL FLAGGED DATA
    ...
    flagged_trades_data_buy_limit_shorts = [trade for trade in flagged_trades_data if trade['trade_position'] == 'short' and trade['trade_action'] == 'buy' and trade['trade_entry'] == 'limit']

# PLACE SL2 FOR SHORT
    if flagged_trades_data_buy_limit_shorts:
        for data in flagged_trades_data_buy_limit_shorts:
            # print(data)
...
def take_trades(db, signal_db, trade_db, futures_db, signal_trade_db, pair):
    ...
    # flagged_long_buy_limit_trades = [trade for trade in flagged_trades if trade['trade_position'] == 'long' and trade['trade_action'] == 'buy' and trade['trade_entry'] == 'limit']
    # flagged_short_buy_limit_trades = [trade for trade in flagged_trades if trade['trade_position'] == 'short' and trade['trade_action'] == 'buy' and trade['trade_entry'] == 'limit']
    # flagged_short_sell_limit_trades = [trade for trade in flagged_trades if trade['trade_position'] == 'short' and trade['trade_action'] == 'sell' and trade['trade_entry'] == 'limit']
...
# IF BULL IS FLAGGED
    ...
    #     this_data = place_futures_order(db, signal_db, trade_db, bank_db, signal_trade_db,
    #                                     pair,
    #                                     flagged_sma50_day_bull_signals[0],
    #                                     not_traded_sma50_bear_day_signals_of_pair[0]['tp_entrance_1'],
    #                                     'long',
    #                                     'sell',
    #                                     'limit')
...
#                                         not_traded_sma50_bull_day_signals_of_pair[0]['tp_entrance_1'],
#                                         'long',
#                                         'buy',
#                                         'limit')
#         to_postman += this_data['to_postman']
...
# IF NEW BEAR signal
    ...
    # UNFLAG AND DEACTIVATE ALL FLAGGED SIGNALS
